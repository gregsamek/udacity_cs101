...
def involved(courses, person):
  ...
  # check every value of the course
  # update result list
  for hexamesters in courses:
    for e in courses[hexamesters]: # individual class offerings
      for p in courses[hexamesters][e]: # attributes e.g. course name, teacher
        if person == courses[hexamesters][e][p]: 
          if hexamesters in result:
            result[hexamesters].append(e)
          else:
            result[hexamesters] = [e]
