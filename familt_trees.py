...
def ancestors(genealogy, person):
	if person not in genealogy:
		return []
	people = []
	people = people + genealogy[person]
	if genealogy[person][0] in genealogy:
		people = people + ancestors(genealogy,genealogy[person][0])
	if genealogy[person][1] in genealogy:
		people = people + ancestors(genealogy,genealogy[person][1])
	return people
